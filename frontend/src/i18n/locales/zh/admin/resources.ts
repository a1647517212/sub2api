export default {
    ...
    usage: {
      ...
      turnStateBlocks: '{n} 块',
      turnStateHint: '密文 {blocks} 块（{chars} 字符）；PKCS#7 下明文落在 {min}–{max} 字节。基线 10 块 = 不降智。块数只能把明文框进 16 字节的窗口，所以这是疑似判据，不是确证。铸于 {minted}',
	  ...
	  turnStateHealthyOnly: '新值健康(10 块)',
	  turnStateSuspectOnly: '新值疑似降智(非 10 块)',
