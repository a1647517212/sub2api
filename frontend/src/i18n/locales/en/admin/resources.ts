export default {
    ...
    usage: {
      ...
      turnStateHint: '{chars} chars (ciphertext {blocks} blocks); under PKCS#7 the plaintext falls in {min}–{max} bytes. Baseline is 292 chars. Block count only brackets the plaintext to a 16-byte window, so this is a suspicion, not proof. Minted {minted}',
	  ...
	  turnStateHealthyOnly: 'New value healthy (292)',
	  turnStateSuspectOnly: 'New value suspect (not 292)',
