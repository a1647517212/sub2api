...
// marshalCodexTurnMetadata is the upstream helper for callers that rebuild a metadata object.
// Fingerprint convergence does not use it; in-place rewrite keeps key order.
